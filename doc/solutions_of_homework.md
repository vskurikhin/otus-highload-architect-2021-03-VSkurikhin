...
- [Решение домашних заданий](solutions_of_homework.md)
  ...
  11. [Внедрение docker и consul](solutions_of_homework.md#Intro-docker-и-consul)
...
### [Сервис счетчиков](solutions_of_homework.md#counter-service)
...
использование кешей.
- [x] Разработайте сервис счетчиков.
...
- [x] Внедрите сервис для отображения счетчиков.
...
### [Внедрение docker и consul](solutions_of_homework.md#Intro-docker-и-consul)
